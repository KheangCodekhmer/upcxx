            ...
            <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl p-8 text-white">
              <div className="space-y-4">
                ...
                <div className="bg-black/20 rounded-lg p-4 font-mono text-sm">
                  ...
                  <div className="ml-4 text-blue-300">name: <span className="text-yellow-300">"Alex Chen"</span>,</div>
                  <div className="ml-4 text-blue-300">passion: <span className="text-yellow-300">"Building amazing things"</span>,</div>
                  <div className="ml-4 text-blue-300">experience: <span className="text-yellow-300">"5+ years"</span>,</div>
